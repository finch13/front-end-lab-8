...
const control = {
    ...
    orderAscending: function (sortParameter) {
    ...
    orderDescending: function (sortParameter) {
        model.allPersons.sort(function (a, b) {
            if (a[sortParameter] < b[sortParameter]) {
                return 1;
            }
...
const sortNameScore = {
    ...
    render: function () {
        let template = `
            <li class="sort-name">Name</li>
            <li class="sort-score">Score</li>
        `;
    ...
    handleClicks: function () {
        this.$container.on('click', 'li', function (e) {
            let sortParameter = $(this).text().toLowerCase();
